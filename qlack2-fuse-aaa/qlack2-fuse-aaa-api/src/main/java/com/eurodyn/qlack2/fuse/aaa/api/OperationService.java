...
public interface OperationService {
	 ...
	 * 
	 * @param operationDTO
	 *            The information of the operation to create
	 ...
	 * 
	 * @param operationDTO
	 *            The details of the operation to update. The operation ID is
	 ...
	 * 
	 * @param userID
	 *            The ID of the user to grant the operation to
	 * @param operationName
	 ...
	 * 
	 * @param userID
	 *            The ID of the user to grant the operations to
	 * @param templateID
	 ...
	 * 
	 * @param groupID
	 *            The ID of the group to grant the operation to
	 * @param operationName
	 *            The name of the operation
	 * @param isDeny
	 *            True if the operation should be denied (negative permission),
	 ...
	 * 
	 * @param groupID
	 *            The ID of the group to grant the operations to
	 * @param templateID
	 *            The ID of the template to use
	 */
	 ...
	 *
	 * @param userID
	 *            The id of the user for whom to check the operation
	 * @param operationName
	 ...
	 * @throws QDynamicOperationException
	 *             If an error occurs while evaluating a dynamic operation.
	 */
	 ...
	 *            The object of the resource for which to perform the check
	 * @return true, if the user is allowed the operation. false, if the user is
	 *         denied the operation. null, if there is no information available
	 *         to reply accordingly.
	 * @throws QDynamicOperationException
	 ...
	 *
	 * @param groupID
	 *            The id of the group for which to check the operation
	 * @param operationName
	 *            The name of the operation to check
	 ...
	 * @param operationName
	 *            The name of the operation to check
	 * @param checkUserGroups
	 *            If true the permissions of each user's groups will also be
	 ...
	 * @param resourceObjectID
	 *            The ID of the resource object to check.
	 * @param checkUserGroups
	 *            If true the permissions of each user's groups will also be
	 *            checked in order to find the users who can perform the
	 *            specified operation. Otherwise, only permissions assigned
	 ...
	 *            If true the ancestors of each group will also be checked,
	 ...
	 * 
	 * @param userID
	 *            The ID of the user for whom to retrieve the permitted
	 *            operations
	 * @param checkUserGroups
	 *            If true the user's groups will also be checked in order to
	 ...
	 *            operations
	 * @param resourceObjectID
	 *            The ObjectID of the resource for which to check.
	 * @param checkUserGroups
	 *            If true the user's groups will also be checked in order to
	 ...
	 * 
	 * @param userID
	 *            The ID of the user for whom to retrieve the resources
	 * @param operationName
	 *            The name of the operation for whom to retrieve the resources
	 * @param getAllowed
	 ...
	 * 
	 * @param operationID
	 *            The ID of the operation to lookup.
	 ...
	 * @param userId
	 *            user ID
	 * @return List<String> A list of ID groups
	 * 
	 */
